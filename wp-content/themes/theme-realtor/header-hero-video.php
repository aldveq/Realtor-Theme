...
<body <?php body_class('olly-olly-hero-image-container-body olly-olly-hero-video-container-body'); ?>>
<?php
...
<div id="page" class="site">
	...
	<?php
		if(!empty($args['video_url']) && !empty($args['image_url'])):
	?>

		<div class="olly-olly-hero-image-container__header olly-olly-hero-video-container__header">
			<div class="olly-olly-hero-image-container__social-networks-container olly-olly-hero-video-container__social-networks-container">
				<div class="container">
					<ul class="olly-olly-hero-image-container__social-networks-nav olly-olly-hero-video-container__social-networks-nav">
						<?php
			...
			<header id="masthead" class="site-header olly-olly-realtor-theme-header olly-olly-hero-image-container__theme-header olly-olly-hero-video-container__theme-header">
				<div class="container">
					<div class="olly-olly-realtor-theme-header__logo-container olly-olly-realtor-theme-header__logo-container-legal">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="olly-olly-realtor-theme-header__logo-link olly-olly-hero-image-container__logo-link olly-olly-hero-video-container__logo-link">
							<?php 
								$custom_logo_id = get_theme_mod( 'custom_logo' );
								$custom_logo_url = wp_get_attachment_image_url( $custom_logo_id , 'full' );		
								$custom_logo_alt = get_post_meta($custom_logo_id, '_wp_attachment_image_alt', TRUE);
							?>
							<img src="<?php echo $custom_logo_url; ?>" class="olly-olly-realtor-theme-header__logo olly-olly-hero-image-container__logo olly-olly-hero-video-container__logo" alt="<?php echo $custom_logo_alt; ?>">
						</a>				
						<!-- <button class=""></button> -->
						<button class="button button__hamburguer hamburger hamburger--spin" type="button" id="hamburguerMenuButton">
							<span class="hamburger-box">
								<span class="hamburger-inner olly-olly-hero-image-container__hamburger-inner olly-olly-hero-video-container__hamburger-inner"></span>
							</span>
						</button>
						<a href="tel:<?php echo $contact_information_group_phone_number; ?>" class="olly-olly-realtor-theme-header__cta-link olly-olly-hero-image-container__cta-phone-number-mobile olly-olly-hero-video-container__cta-phone-number-mobile"><h6><?php echo $contact_information_group_phone_number_title; ?><span class="olly-olly-realtor-theme-header__cta-number"><?php echo $contact_information_group_phone_number; ?></span></h6></a>
					</div>
					<nav class="olly-olly-realtor-theme-header__nav-container <?php echo $legal_settings_is_legal_settings_available == 'yes' ? 'olly-olly-realtor-theme-header__nav-container-legal' : ''; ?>">
						<?php
							wp_nav_menu(array(
								...
								'depth'	=> 0,
								'menu_class' => 'olly-olly-realtor-theme-header__nav-list olly-olly-hero-image-container__nav-list olly-olly-hero-video-container__nav-list',
							));
						?>
						
						<a href="tel:<?php echo $contact_information_group_phone_number; ?>" class="olly-olly-realtor-theme-header__cta-link olly-olly-realtor-theme-header__cta-link--desktop olly-olly-hero-image-container__cta-link-desktop olly-olly-hero-video-container__cta-link-desktop"><h6><?php echo $contact_information_group_phone_number_title; ?><span class="olly-olly-realtor-theme-header__cta-number"><?php echo $contact_information_group_phone_number; ?></span></h6></a>
		...
		<section class="olly-olly-hero-image-container olly-olly-hero-video-container" style="background-image: url(<?php echo $args['image_url']; ?>); background-repeat: no-repeat; background-size: cover; background-position: center;">

			<div class="olly-olly-hero-video-container__video-foreground ar-16-by-9">
				<iframe width="100%" height="100%" src="<?php echo get_formatted_video_url($args['video_url']); ?>" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
			</div>

			<div class="olly-olly-hero-image-container__body olly-olly-hero-video-container__body">
				<div class="container">
					<?php
						if(!empty($home_hero_settings_title)):
							?>
								<h1 class="olly-olly-hero-image-container__body-title olly-olly-hero-video-container__body-title"><?php echo $home_hero_settings_title; ?></h1>
							<?php
						endif;
					?>
					<?php
						if(!empty($home_hero_settings_link)):
							$home_hero_settings_link_target = $home_hero_settings_link['target'] ? $home_hero_settings_link['target'] : '_self';
							?>
								<a href="<?php echo $home_hero_settings_link['url']; ?>" target="<?php echo $home_hero_settings_link_target; ?>" class="button button__filled olly-olly-hero-image-container__body-button olly-olly-hero-video-container__body-button" style="color: <?php echo $secondary_color; ?> !important;"><?php echo $home_hero_settings_link['title']; ?></a>
							<?php
						endif;
					?>
				</div>
