...
<head>
	...
	<style>
		...
		*/
		...
		.olly-olly-hero-header, 
		.olly-olly-hero-header.fixed {
			background-color: <?php echo convert_hex_to_rgba($secondary_color, 0.95); ?>;
		}

		.olly-olly-hero-image-container__nav-list li.current-menu-parent.menu-item-has-children>a {
			color: #fff !important;
		}
		...
		@media screen and (min-width: 1366px) {
			...
			.olly-olly-hero-image-container__nav-list li ul.sub-menu li.current-menu-item {
				background-color: transparent !important;
			}
...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header olly-olly-realtor-theme-header olly-olly-hero-image-container__theme-header olly-olly-hero-header">
        <div class="container">
